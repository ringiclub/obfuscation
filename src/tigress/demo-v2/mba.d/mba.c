  ...
  "Transformations": [
    ...
    "TransformationUpdates": {
      ...
      "New Types": [
        ...
        "__mbstate_t", "__anonstruct___mbstate_t_496680313",
...
/* BEGIN STRUCT-DECL __anonstruct___mbstate_t_496680313 LOC=/usr/include/x86_64-linux-gnu/bits/types/__mbstate_t.h:13 */
struct __anonstruct___mbstate_t_496680313 ;
/* END STRUCT-DECL __anonstruct___mbstate_t_496680313 LOC=/usr/include/x86_64-linux-gnu/bits/types/__mbstate_t.h:13 */
...
/* BEGIN STRUCT __anonstruct___mbstate_t_496680313 LOC=/usr/include/x86_64-linux-gnu/bits/types/__mbstate_t.h:13 */
struct __anonstruct___mbstate_t_496680313 {
   int __count ;
   union __anonunion___value_771759453 __value ;
};
/* END STRUCT __anonstruct___mbstate_t_496680313 LOC=/usr/include/x86_64-linux-gnu/bits/types/__mbstate_t.h:13 */

/* BEGIN TYPEDEF __mbstate_t LOC=/usr/include/x86_64-linux-gnu/bits/types/__mbstate_t.h:13 */
typedef struct __anonstruct___mbstate_t_496680313 __mbstate_t;
...
{ 
  ...
  {
  correct = 1;
  printf((char const   */* __restrict  */)"Please enter the string: ");
  fgets((char */* __restrict  */)(input_string), (int )sizeof(input_string), (FILE */* __restrict  */)stdin);
  tmp___0 = strcspn((char const   *)(input_string), "\n");
  input_string[tmp___0] = (char )'\000';
  tmp___2 = strlen((char const   *)(input_string));
  tmp___3 = strlen(good_string);
  }
  if ((int )((((tmp___2 - tmp___3) | (tmp___3 - tmp___2)) >> 63UL) & 1UL)) {
    correct = 0;
  } else {
    i = 0;
    while (1) {
      tmp___1 = strlen(good_string);
      if (! ((int )((((~ ((size_t )i) & tmp___1) | ((~ ((size_t )i) | tmp___1) & ((size_t )i - tmp___1))) >> 63UL) & 1UL))) {
        break;
      }
      if (((unsigned int )(((((int )input_string[i] - (int )*(good_string + i)) >> 31) - ((int )input_string[i] - (int )*(good_string + i))) ^ (((int )input_string[i] - (int )*(good_string + i)) >> 31)) >> 31U) & 1) {
        correct = 0;
        break;
      } else {
        strncat((char */* __restrict  */)(result), (char const   */* __restrict  */)(& input_string[i]),
                (size_t )1);
      }
      i = ((i ^ ~ 1) + ((i | 1) << 1)) + 1;
    }
  }
  tmp___6 = strcmp((char const   *)(result), good_string);
  if (((unsigned int )(~ tmp___6 & (tmp___6 - 1)) >> 31U) & 1) {
    tmp___5 = "";
  } else {
    tmp___5 = "in";
  }
  printf((char const   */* __restrict  */)"The string is %scorrect \n", tmp___5);
  return (0);
}
}
