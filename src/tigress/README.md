...
## Graph view
![](../../assets/images/pseudocode/initopaque.png)
...
tigress \
   ...
   --Functions=* \
   obfuscation-demo.c \
   --out=tigress/code/opaquePredicate.d/initOpaque.c
```
...
## Graph view
![](../../assets/images/pseudocode/mba.png)
...
## Graph view
![](../../assets/images/pseudocode/flattening.png)
...
tigress \
  ...
  obfuscation-demo.c \
  --out=tigress/code/flattening.d/flattening.c
```
...
## Graph view
![](../../assets/images/pseudocode/bogus.png)
...
tigress \
  ...
  --AntiAliasAnalysisBogusEntries=true \
    obfuscation-demo.c \
  --out=tigress/code/bogus.d/antiAliasAnalysis.c
```